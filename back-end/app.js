...
//mongoDB'
mongoose.connect('mongodb://Moode:moode@ds237808.mlab.com:37808/mern-challenge');
//express
var app = express();
...
app.post('/api/register', [
    ...
    check('password','your password should be more than 6 charchters').isLength({min:7}),
